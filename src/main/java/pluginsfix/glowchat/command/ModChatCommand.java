...
public class ModChatCommand implements CommandExecutor, TabCompleter {
    private final GlowChat plugin;

    public ModChatCommand(GlowChat plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        sendModChatMessage(sender, message, config);
        return true;
    }

    public static void sendModChatMessage(CommandSender sender, String message, GlowChatConfig config) {
        String senderName = sender.getName();
        String format = config.getModChatFormat()
        ...
        for (Player online : Bukkit.getOnlinePlayers()) {
            if (online.hasPermission("glowchat.modchat") || online.hasPermission("glowchat.adminchat")) {
